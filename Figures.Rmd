...
BRET_results <- BRET_results %>% mutate(include=case_when(NL_symbol=="IQCB1" &  mCit_symbol=="MNS1" & project_id=="Lu153r01" ~ "1",
                                                          NL_plasmid=="pcDNA3.1 cmyc-NL-SPOP_S119L" &  mCit_symbol=="MYD88" & project_id=="Lu171r01" ~ "1",
...
# SAVE TIFF
tiff("/Users/jesusav/Desktop/Heatmaps/DomainValidation_CTBP1.tiff", units="cm", width=8, height=12, res=800)
...
# SAVE TIFF
tiff("/Users/jesusav/Desktop/Heatmaps/DomainValidation_SPOP.tiff", units="cm", width=8, height=9, res=800)
grid.arrange(p1, p2, heights=c(2.1,3), nrow=2, bottom=textGrob("SPOP domain mutants", gp = gpar(fontsize = 20)) )
dev.off()
...
# SAVE TIFF
tiff("/Users/jesusav/Desktop/Heatmaps/DomainValidation_WWOX.tiff", units="cm", width=8, height=20, res=800)
...
# SAVE TIFF
tiff("/Users/jesusav/Desktop/Heatmaps/DomainValidation_PPP3CA.tiff", units="cm", width=8, height=12, res=800)
...
# SAVE TIFF
tiff("/Users/jesusav/Desktop/Heatmaps/DomainValidation_IQCB1.tiff", units="cm", width=7, height=7.5, res=800)
...
# SAVE TIFF
tiff("/Users/jesusav/Desktop/Heatmaps/MotifValidation_CTBP1.tiff", units="cm", width=8.5, height=5, res=800)
...
# SAVE TIFF
tiff("/Users/jesusav/Desktop/Heatmaps/MotifValidation_SPOP.tiff", units="cm", width=9, height=10, res=800)
...
# SAVE TIFF
tiff("/Users/jesusav/Desktop/Heatmaps/MotifValidation_WWOX.tiff", units="cm", width=9, height=14, res=800)
...
# SAVE TIFF
tiff("/Users/jesusav/Desktop/Heatmaps/MotifValidation_PPP3CA.tiff", units="cm", width=11, height=4.5, res=800)
...
grid.arrange(p1, p2, nrow=2, left=textGrob("Motif deletions", gp = gpar(fontsize = 20), rot=90 ))
# SAVE TIFF
tiff("/Users/jesusav/Desktop/Heatmaps/MotifValidation_IQCB1.tiff", units="cm", width=10, height=6.5, res=800)
grid.arrange(p1, p2, heights=c(2,3.3), nrow=2, left=textGrob("Motif deletions", gp = gpar(fontsize = 20), rot=90) )
dev.off()
# # SAVE TIFF
...
# SAVE TIFF
tiff("/Users/jesusav/Desktop/Heatmaps/VariantTest_CTBP1_motif.tiff", units="cm", width=9, height=8, res=800)
...
# SAVE TIFF
tiff("/Users/jesusav/Desktop/Heatmaps/VariantTest_SPOP_domain.tiff", units="cm", width=5.5, height=11, res=800)
...
# SAVE TIFF
tiff("/Users/jesusav/Desktop/Heatmaps/VariantTest_WWOX_motif.tiff", units="cm", width=9, height=13, res=800)
...
# SAVE TIFF
tiff("/Users/jesusav/Desktop/Heatmaps/VariantTest_PPP3CA_motif.tiff", units="cm", width=7, height=6, res=800)
...
p1 <- ggplot(mutants_BRET %>% filter(NL_symbol=="IQCB1" & motif_variant==TRUE) %>% 
  ...
  theme(text = element_text(size = 20), panel.grid.major = element_blank(), legend.position = "none",
        ...
        axis.text.x=element_blank()) +
  scale_y_discrete(limits=rev) + 
  facet_nested(. ~ category + ClinVar , scales = "free_x",switch = "x",space = "free_x",
                  strip = strip_nested(text_x = element_text(size=0))
                 )
...
p2 <- ggplot(mutants_BRET %>% filter(NL_symbol=="IQCB1" & motif_variant==TRUE) %>% 
  ...
  facet_nested(. ~ category + ClinVar , scales = "free_x",switch = "x",space = "free_x",
                  strip = strip_nested(text_x = element_text(size=0),
                    background_x = elem_list_rect(fill = c("green", "magenta", "#d52221", "#999999", "#999999"))
                 ))
grid.arrange(p1, p2, nrow=2, bottom=textGrob("Domain variants", gp = gpar(fontsize = 20) ))

# SAVE TIFF
tiff("/Users/jesusav/Desktop/Heatmaps/VariantTest_IQCB1_domain.tiff", units="cm", width=13, height=9, res=800)
grid.arrange(p1, p2, nrow=2, heights=c(2.3,4), bottom=textGrob("Domain variants", gp = gpar(fontsize = 20) ))
dev.off()
# # SAVE TIFF
...
# SAVE TIFF
tiff("/Users/jesusav/Desktop/Heatmaps/VariantTest_IQCB1_motif.tiff", units="cm", width=9.5, height=9, res=800)
