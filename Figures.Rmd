...
# SAVE TIFF
tiff("Figures/SuppFig_DMI_HuRI_graphics/HuRI_DMI_highScore_Classes_fraction.tiff", units="cm", width=11, height=8, res=800)
p2
dev.off()
...
# SAVE TIFF
tiff("Figures/Figure2_graphics/HuRI_human_ClinVar_mutations_ELM.tiff", units="cm", width=11, height=8, res=800)
p1
dev.off()
...
grid.arrange(p1, p2 + theme(axis.title=element_blank(),axis.text.y = element_blank()),  widths=c(6,5), nrow=1)

# SAVE TIFF
tiff("Figures/Figure4_graphics/BRET_mutants_scores_BRET.tiff", units="cm", width=11, height=7, res=800)
grid.arrange(p1, p2 + theme(axis.title=element_blank(),axis.text.y = element_blank()), widths=c(6,5),  nrow=1)
dev.off()

# SAVE TIFF
tiff("Figures/Figure4_graphics/BRET_mutants_scores_BRET50.tiff", units="cm", width=7, height=7, res=800)
p1 
dev.off()

# SAVE TIFF
tiff("Figures/Figure4_graphics/BRET_mutants_scores_maxBRET.tiff", units="cm", width=7, height=7, res=800)
p2 
dev.off()
```
...
```{r Figure5_Graph_Supp_fragments}
