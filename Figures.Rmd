...
```{r Figure1_SuppData_FeatureImportance, eval=F}
## Load feature importarnce table for RRS4
features <- read_csv("...DMI_ML_FeatureImportance.csv")
...
```{r EF_Figure1_Graphic_b_FeatureImportance, evaluate=F}
...
p1
#SAVE PNG
tiff("Figures/ExtendedFigure_1/RF_feature_importance.tiff", units="cm", width=12, height=8, res=800)
p1
dev.off()
...
holdouts <- read_csv("/Users/jesusav/Desktop/RF_testing/Datasets/ROC_PR_Holdouts.csv")
